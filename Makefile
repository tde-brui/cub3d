SOURCES		:=	main.c mlx.c player.c cleanup.c raycasting.c map.c parse.c utils.c movement.c dda.c draw.c textures.c draw_utils.c utils2.c error.c init.c flood_fill.c
VPATH		:=	src/
BUILD		:=	build
